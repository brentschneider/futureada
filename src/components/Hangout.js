...
const Hangout = (props) => (
  ...
  <section className="container u-m-t-100">
    ...
    <a href="https://business.facebook.com/futureada/" target="_blank" className="button u-m-t-20">FACEBOOK PAGE</a>
    </section>
    ...
    <a href="https://twitter.com/futureada" target="_blank" className="button u-m-t-20">TWITTER</a>
    </section>
    ...
    <a href="https://www.linkedin.com/company/futureada/" target="_blank" className="button u-m-t-20">LINKEDIN</a>
    </section>
